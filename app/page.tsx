    ...
    <ClientOnly>
      <div className="w-screen min-h-screen relative bg-gradient-to-br from-indigo-100 via-violet-100 to-purple-200">
        ...
        {/* <Link href="/" className="absolute top-8 left-8">
          <Image src="/docChat-logo.svg" alt="logo" width="140" height="100" />
        </Link> */}
        <div className="w-full h-full flex flex-col items-center justify-center gap-3 px-5">
          ...
          <div className="flex gap-15 mt-5 mb-20 text-center">
            <div className="flex flex-col w-2/3 gap-4">
              {/* <Image src="./" alt="logo" width="140" height="100" /> */}
              <h3 className="text-2xl text-gray-800">Upload Your PDF</h3>
              <p className="text-center text-gray-800">Simply drag and drop your PDF file and click to upload, and start using the tool instantly.</p>
            </div>
            <div className="flex flex-col w-2/3 gap-4">
              <h3 className="text-2xl text-gray-800">Ask Questions</h3>
              <p className="text-center text-gray-800">Get instant summaries, extract information and ask any questions about your document with AI.</p>
            </div>
          </div>
          <div className="bg-gray-900 w-screen h-[250px] flex gap-30 text-center">
            <div className="flex flex-col w-1/3 items-center justify-center text-white m-10 w-1/3 px-10">
            ...
            <div className="flex flex-col w-2/3 items-center justify-center text-white mt-10">
